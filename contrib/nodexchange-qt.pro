...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/nodexchange-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/nodexchange-cli.cpp \
           src/nodexchange-tx.cpp \
           src/nodexchange.cpp \
           src/db.cpp \
           ...
           src/qt/nodexchange.cpp \
           src/qt/nodexchangestrings.cpp \
...
RESOURCES += src/qt/nodexchange.qrc src/qt/nodexchange_locale.qrc

TRANSLATIONS += src/qt/locale/nodexchange_bg.ts \
                src/qt/locale/nodexchange_de.ts \
                src/qt/locale/nodexchange_en.ts \
                src/qt/locale/nodexchange_es.ts \
                src/qt/locale/nodexchange_fi.ts \
                src/qt/locale/nodexchange_fr.ts \
                src/qt/locale/nodexchange_it.ts \
                src/qt/locale/nodexchange_ja.ts \
                src/qt/locale/nodexchange_pl.ts \
                src/qt/locale/nodexchange_pt.ts \
                src/qt/locale/nodexchange_ru.ts \
                src/qt/locale/nodexchange_sk.ts \
                src/qt/locale/nodexchange_sv.ts \
                src/qt/locale/nodexchange_vi.ts \
                src/qt/locale/nodexchange_zh_CN.ts \
                src/qt/locale/nodexchange_zh_TW.ts
