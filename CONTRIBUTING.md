Contributing to NodeXchange Core
============================

The NodeXchange Core project operates an open contributor model where anyone is
...
The following applies to code changes to the NodeXchange Core project, and is not to be
confused with overall NodeXchange Network Protocol consensus changes.

Whether a pull request is merged into NodeXchange Core rests with the project merge
...
Patches that change NodeXchange consensus rules are considerably more involved than
...
Where a patch set proposes to change the NodeXchange consensus, it must have been
...
The project leader is the release manager for each NodeXchange Core release.
