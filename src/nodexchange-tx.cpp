...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("NodeXchange Core nodexchange-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nodexchange-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nodexchange transaction") + "\n" +
                               "  nodexchange-tx [options] -create [commands]   " + _("Create hex-encoded nodexchange transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nodexchange transaction
