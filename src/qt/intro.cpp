...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("NodeXchange Core"),
     ...
     * override -datadir in the nodexchange.conf file in the default data directory
     * (to be consistent with nodexchanged behavior)
     */
    if (dataDir != getDefaultDataDirectory())
