...
/** Utility functions used by the NodeXchange Qt UI.
 */
namespace GUIUtil
{
...
// Render NodeXchange addresses in monospace font
...
// Parse "nodexchange:" URI into recipient object, return true on successful parsing
