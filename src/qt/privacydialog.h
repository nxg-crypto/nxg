...
public:
    ...
    void setZNodeXchangeControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzNXG_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzNXG_clicked();
    void on_pushButtonZNodeXchangeControl_clicked();
