                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("NodeXchange Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NodeXchange address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nodexchange: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About NodeXchange Core"), this);
    aboutAction->setStatusTip(tr("Show information about NodeXchange Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NodeXchange"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NodeXchange addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NodeXchange addresses"));
    ...
    openAction->setStatusTip(tr("Open a NodeXchange: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NodeXchange Core help message to get a list with possible NodeXchange command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("NodeXchange Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NodeXchange network", "", count));
}
...
{
    QString strTitle = tr("NodeXchange Core"); // default title
...
/** Creates context menu, its actions, and nodexchanges up all the relevant signals for mouse events. */
