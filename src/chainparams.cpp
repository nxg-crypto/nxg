...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x000004557366817103d3c0e1205a9416f25e64aa8a6218a11effab3abc4d9bd7"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1544616059, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("0416817109703470b279dda18353f893a90c7d60a74c069ef108c1ea02570a5e40930bc9ab4d7e9fa449df0d3a20a3f4e27eb7fb0b329c8fe6e55b29c6bd8f49f2");
        nDefaultPort = 28320;
        bnProofOfWorkLimit = ~uint256(0) >> 20; //20 NodeXchange starting difficulty is 1 / 2^12
        ...
        nZerocoinStartTime = 1644616059;
        nBlockEnforceSerialRange = 1; //Enforce serial range starting this block
        nBlockRecalculateAccumulators = ~1; //Trigger a recalculation of accumulators
        nBlockFirstFraudulent = ~1; //First block that bad serials emerged
        nBlockLastGoodCheckpoint = ~1; //Last valid accumulator checkpoint
        const char* pszTimestamp = "NodeXchange new blockchain is here";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1544616059;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 2195144;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000004557366817103d3c0e1205a9416f25e64aa8a6218a11effab3abc4d9bd7"));
        assert(genesis.hashMerkleRoot == uint256("0x0b563dfcfd9ae1620e2256b8123e90b30dc87bc50bc2fefe896bb6739de1305b"));

	vSeeds.push_back(CDNSSeedData("45.63.117.236", "45.63.117.236"));
        vSeeds.push_back(CDNSSeedData("107.191.47.198", "107.191.47.198"));
        vSeeds.push_back(CDNSSeedData("104.238.189.120", "104.238.189.120"));
	...
	strSporkKey = "0484B8098B2AC303EC948C8AEC781A86451AD084B7B8B0B7BB520B7A5E0D1FC9D4BC2BEBF8CECECBED16221570AEF52C344BED99B7B40A58BA1601227B4C3CDEF3";
        strObfuscationPoolDummyAddress = "NZkzhpANBTAd2wuYzG8DjGmmByNS7qZ7nW";
        nStartMasternodePayments = 1544616059;
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // NodeXchange: 1 day
        nTargetSpacing = 1 * 60;  // NodeXchange: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet nodexchange addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet nodexchange script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet nodexchange BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet nodexchange BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet nodexchange BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // NodeXchange: 1 day
        nTargetSpacing = 1 * 60;        // NodeXchange: 1 minutes
