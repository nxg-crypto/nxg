...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop NodeXchange server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "NodeXchange server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"nodexchange", "masternode", &masternode, true, true, false},
        {"nodexchange", "listmasternodes", &listmasternodes, true, true, false},
        {"nodexchange", "getmasternodecount", &getmasternodecount, true, true, false},
        {"nodexchange", "masternodeconnect", &masternodeconnect, true, true, false},
        {"nodexchange", "masternodecurrent", &masternodecurrent, true, true, false},
        {"nodexchange", "masternodedebug", &masternodedebug, true, true, false},
        {"nodexchange", "startmasternode", &startmasternode, true, true, false},
        {"nodexchange", "createmasternodekey", &createmasternodekey, true, true, false},
        {"nodexchange", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"nodexchange", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"nodexchange", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"nodexchange", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"nodexchange", "getmasternodescores", &getmasternodescores, true, true, false},
        {"nodexchange", "mnbudget", &mnbudget, true, true, false},
        {"nodexchange", "preparebudget", &preparebudget, true, true, false},
        {"nodexchange", "submitbudget", &submitbudget, true, true, false},
        {"nodexchange", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"nodexchange", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"nodexchange", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"nodexchange", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"nodexchange", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"nodexchange", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"nodexchange", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nodexchange", "checkbudgets", &checkbudgets, true, true, false},
        {"nodexchange", "mnsync", &mnsync, true, true, false},
        {"nodexchange", "spork", &spork, true, true, false},
        {"nodexchange", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"nodexchange", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use nodexchanged, or the -server option to nodexchange-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> nodexchange-cli " + methodname + " " + args + "\n";
}
