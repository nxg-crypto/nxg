...
In order to support loading of multiple wallets in nodexchange-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nodexchange.cpp.
...
Changes to nodexchange.cpp
----------------------
nodexchange.cpp is the entry point into nodexchange-qt, and as such, will require some minor modifications to provide hooks for
